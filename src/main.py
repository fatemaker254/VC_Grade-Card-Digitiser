...
from validate import normalize_fail_credit_points
    ...
    for i, img_path in enumerate(image_paths, start=1):
        try:
            ...
            if args.single_pass:
                ...
                final, notes, _items = reconcile(pass1, pass2)
                final["_review_notes"] = notes
            for note in normalize_fail_credit_points(final):
                print(f"      auto-corrected: {note}")
